...
function update() {
    ...
    if (submit.value === "Another") {
        ...
        if (document.getElementById("s6").checked) {
            hashWordSize = 6;
        } else if (document.getElementById("s8").checked) {
            hashWordSize = 8;
        } else if (document.getElementById("s10").checked) {
            hashWordSize = 10;
        } else if (document.getElementById("s12").checked) {
            hashWordSize = 12;
        } else if (document.getElementById("s14").checked) {
            hashWordSize = 14;
        } else if (document.getElementById("s16").checked) {
            hashWordSize = 16;
        } else if (document.getElementById("s18").checked) {
            hashWordSize = 18;
        } else if (document.getElementById("s20").checked) {
            hashWordSize = 20;
        } else if (document.getElementById("s22").checked) {
            hashWordSize = 22;
        } else if (document.getElementById("s24").checked) {
            hashWordSize = 24;
        } else if (document.getElementById("s26").checked) {
            hashWordSize = 26;
        }
...
function onSelectSiteTag(fld) {
    ...
    var hashWordSize = (sizeMatch !== null && 0 < sizeMatch.length)
